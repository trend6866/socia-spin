<div class="container mw-700 py-5">
    ...
    <?php if ( get_option("facebook_page_official_status", 1) && get_option("facebook_page_cookie_status", 1) ): ?>
    ...
    <div class="tab-content" id="tab_plans">
        <?php if ( get_option("facebook_page_official_status", 1) ): ?>
        ...
        <?php if ( get_option("facebook_page_cookie_status", 1) ): ?>
        <div class="tab-pane fade <?php _ec( (!get_option("facebook_page_official_status", 1))?"active show mt-5":"" )?> " id="oauth_tab_2" role="tabpanel">
